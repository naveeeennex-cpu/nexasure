...
const projects = [
  ...
  },
  {
    ...
    screenshots: [
      { src: 'https://github.com/naveeeennex-cpu/nexasure/tree/main/portfolio-images/matchinminutes/landingpage_MIM.png', label: 'Landing Page' },
      { src: 'https://github.com/naveeeennex-cpu/nexasure/tree/main/portfolio-images/matchinminutes/sigin_MIM.png', label: 'Sign In' },
      { src: 'https://github.com/naveeeennex-cpu/nexasure/tree/main/portfolio-images/matchinminutes/discovery_MIM.png', label: 'Partner Discovery' },
      { src: 'https://github.com/naveeeennex-cpu/nexasure/tree/main/portfolio-images/matchinminutes/myprofile_MIM.png', label: 'My Profile' },
      { src: 'https://github.com/naveeeennex-cpu/nexasure/tree/main/portfolio-images/matchinminutes/message_MIM.png', label: 'Messages' },
      { src: 'https://github.com/naveeeennex-cpu/nexasure/tree/main/portfolio-images/matchinminutes/Gift_MIM.png', label: 'Send Gift' },
      { src: 'https://github.com/naveeeennex-cpu/nexasure/tree/main/portfolio-images/matchinminutes/credit_MIM.png', label: 'Credits' },
      { src: 'https://github.com/naveeeennex-cpu/nexasure/tree/main/portfolio-images/matchinminutes/package_MIM.png', label: 'Packages' },
    ],
  },
  {
    title: 'Aptirix',
