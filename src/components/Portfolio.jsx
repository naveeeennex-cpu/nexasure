...
const projects = [
  ...
  },
  {
    ...
    screenshots: [
      ...
      { src: 'https://github.com/naveeeennex-cpu/nexasure/tree/main/portfolio-images/matchinminutes/sigin_MIM.png?raw=true', label: 'Sign In' },
      { src: 'https://github.com/naveeeennex-cpu/nexasure/tree/main/portfolio-images/matchinminutes/discovery_MIM.png?raw=true', label: 'Partner Discovery' },
      { src: 'https://github.com/naveeeennex-cpu/nexasure/tree/main/portfolio-images/matchinminutes/myprofile_MIM.png?raw=true', label: 'My Profile' },
      { src: 'https://github.com/naveeeennex-cpu/nexasure/tree/main/portfolio-images/matchinminutes/message_MIM.png?raw=true', label: 'Messages' },
      { src: 'https://github.com/naveeeennex-cpu/nexasure/tree/main/portfolio-images/matchinminutes/Gift_MIM.png?raw=true', label: 'Send Gift' },
      { src: 'https://github.com/naveeeennex-cpu/nexasure/tree/main/portfolio-images/matchinminutes/credit_MIM.png?raw=true', label: 'Credits' },
      { src: 'https://github.com/naveeeennex-cpu/nexasure/tree/main/portfolio-images/matchinminutes/package_MIM.png?raw=true', label: 'Packages' },
    ],
  },
  {
    title: 'Aptirix',
