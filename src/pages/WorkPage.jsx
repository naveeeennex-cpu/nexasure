...
import { ArrowLeft, ExternalLink, CheckCircle2, Smartphone, Globe, Phone, Briefcase, Package } from 'lucide-react'
...
export default function WorkPage() {
  ...
  const work = getClientWorkBySlug(slug)
  ...
  const mobile = isMobileCategory(work.category)
  const CategoryIcon = categoryIcon[work.category] || Globe
  ...
  return (
    <div className="min-h-screen bg-dark">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div
          className="absolute top-20 left-1/2 -translate-x-1/2 w-[800px] h-[400px] rounded-full blur-[140px] opacity-25 pointer-events-none"
          style={{ backgroundColor: work.accent }}
        />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(34,211,238,0.06)_0%,transparent_60%)] pointer-events-none" />
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          <div className="grid lg:grid-cols-[auto_1fr] gap-8 items-start">
            <motion.div
              ...
              className={`w-24 h-24 md:w-28 md:h-28 rounded-3xl border p-3 flex items-center justify-center shadow-xl ${
                work.logo ? 'bg-white border-white/20' : 'bg-white/[0.04] border-white/10'
              }`}
              style={{ boxShadow: `0 20px 60px ${work.accent}20` }}
            >
              {work.logo ? (
                <img
                  src={work.logo}
                ...
                <CategoryIcon size={36} style={{ color: work.accent }} />
              )}
            </motion.div>
            ...
            <div>
              ...
              >
                ...
                <span className="inline-flex items-center gap-1.5 text-[11px] uppercase tracking-wider font-medium px-2.5 py-1 rounded-full border border-cyan-accent/30 bg-cyan-accent/[0.08] text-cyan-accent">
                  <Briefcase size={11} />
                  {work.status}
                </span>
                <span className="text-xs text-muted">Client: {work.client}</span>
              </motion.div>
          ...
          {work.stats && work.stats.length > 0 && (
            ...
            >
              {work.stats.map((stat) => (
                ...
                >
                  <div className="text-xl md:text-2xl font-bold text-white font-[var(--font-space)]">
                    {stat.value}
                  </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-10">
            <div className="md:col-span-1">
              <p className="text-cyan-accent text-xs font-medium mb-3 tracking-[0.2em] uppercase">Overview</p>
              ...
              {work.deliverables && (
                <div className="mt-8">
                  <h3 className="flex items-center gap-2 text-sm font-semibold text-white mb-4">
                    <Package size={15} className="text-cyan-accent" />
                    What we delivered
                  </h3>
                  <ul className="grid sm:grid-cols-2 gap-2.5">
                    {work.deliverables.map((d) => (
                      <li key={d} className="flex items-start gap-2.5 text-sm text-muted-light">
                        <CheckCircle2 size={15} className="text-cyan-accent shrink-0 mt-0.5" />
                        {d}
                      </li>
                    ))}
                  </ul>
      ...
      <section className="py-20 border-t border-white/[0.06]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            <p className="text-cyan-accent text-xs font-medium mb-3 tracking-[0.2em] uppercase">Capabilities</p>
            ...
            {work.features.map((feature, i) => (
              ...
              >
                <div
                  ...
                  style={{ backgroundColor: work.accent + '20', border: `1px solid ${work.accent}40` }}
                >
                  <CheckCircle2 size={18} style={{ color: work.accent }} />
                </div>
      ...
      <section className="py-20 border-t border-white/[0.06]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-10">
            <p className="text-cyan-accent text-xs font-medium mb-3 tracking-[0.2em] uppercase">Engineering</p>
            <h2 className="text-3xl md:text-4xl font-bold text-white font-[var(--font-space)]">
              Tech stack
            </h2>
          </div>
      ...
      {/* Sectioned screenshots (e.g. Pick Your Slot) */}
      {work.screenshotSections && work.screenshotSections.length > 0 && (
        <section className="py-20 border-t border-white/[0.06]">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-14">
              <p className="text-cyan-accent text-xs font-medium mb-3 tracking-[0.2em] uppercase">A look inside</p>
              <h2 className="text-3xl md:text-4xl font-bold text-white font-[var(--font-space)]">
                Designed flows
              </h2>
            </div>
            ...
            <div className="space-y-16">
              {work.screenshotSections.map((section, si) => (
                <div key={si}>
                  <h3 className="text-lg font-semibold text-white font-[var(--font-space)] mb-6 flex items-center gap-3">
                    <div className="w-1 h-6 rounded-full" style={{ backgroundColor: work.accent }} />
                    {section.title}
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-5 md:gap-6">
                    {section.screenshots.map((shot, i) => (
                      ...
                      >
                        <div className="relative w-full aspect-[9/19.5] rounded-[20px] border-[3px] border-white/[0.12] bg-dark-2 overflow-hidden shadow-lg shadow-black/30 hover:border-cyan-accent/30 transition-colors duration-300 group">
      ...
      {/* Regular screenshots */}
      {!work.screenshotSections && work.screenshots && work.screenshots.length > 0 && (
        <section className="py-20 border-t border-white/[0.06]">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-14">
              <p className="text-cyan-accent text-xs font-medium mb-3 tracking-[0.2em] uppercase">A look inside</p>
              <h2 className="text-3xl md:text-4xl font-bold text-white font-[var(--font-space)]">
                {mobile ? 'App preview' : 'Project preview'}
              </h2>
            </div>
            ...
            {mobile ? (
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
                {work.screenshots.map((shot, i) => (
                  <motion.div
                    ...
                    className="flex flex-col items-center gap-3"
                  >
                    <div className="relative w-full aspect-[9/19.5] rounded-[20px] border-[3px] border-white/[0.12] bg-dark-2 overflow-hidden shadow-xl shadow-black/30 hover:border-cyan-accent/30 transition-colors duration-300 group">
                      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[40%] h-[14px] bg-dark-2 rounded-b-xl z-10" />
                      <img
                        src={shot.src}
                        alt={shot.label}
              ...
              <div className="flex flex-col gap-10 max-w-5xl mx-auto">
                {work.screenshots.map((shot, i) => (
                  ...
                  >
                    <div className="rounded-xl border border-white/[0.1] overflow-hidden shadow-xl shadow-black/30 hover:border-cyan-accent/20 transition-colors duration-300 group">
                      <div className="flex items-center gap-2 px-4 py-2.5 bg-white/[0.04] border-b border-white/[0.06]">
                        ...
                        <div className="flex-1 mx-3">
                          <div className="bg-white/[0.06] rounded-md px-3 py-1 text-[10px] text-muted max-w-[300px]">
                            {work.website || `${work.title.toLowerCase().replace(/\s+/g, '')}.com`}
                          </div>
                        </div>
                      </div>
                      <img
      ...
      <section className="py-24 border-t border-white/[0.06] relative overflow-hidden">
        <div
          ...
          style={{
            background: `radial-gradient(ellipse at center, ${work.accent}20 0%, transparent 60%)`,
          }}
        />
        <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-muted-light mb-8 max-w-xl mx-auto">
            We design, build, and ship products and services for businesses across web, mobile, and AI. Tell us what you need.
          </p>
